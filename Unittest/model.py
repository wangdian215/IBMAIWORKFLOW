...
def model_load(prefix='sl',data_dir=None,training=True):
    ...
    if not data_dir:
        ...
        #data_dir = os.path.join("..","data","cs-train") commented 14Sep 5:42 PM
...
if __name__ == "__main__":
    ...
    data_dir = os.path.join(os.path.expanduser('~'),"AI Workflow Last Module AI in Prod","CapstoneFinal","Unittest","cs-train")
